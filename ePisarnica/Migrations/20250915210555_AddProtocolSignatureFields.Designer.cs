...
namespace ePisarnica.Migrations
{
    ...
    [Migration("20250915210555_AddProtocolSignatureFields")]
    partial class AddProtocolSignatureFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ePisarnica.Models.ProtocolEntry", b =>
                {
                    ...
                    b.Property<string>("SignatureNotes")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ePisarnica.Models.ProtocolEntry", b =>
                {
                    ...
                    b.HasOne("ePisarnica.Models.User", "SignedByUser")
                        .WithMany()
